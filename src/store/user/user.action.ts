...
import { AdditionalInformation, UserData } from "../../util/firebase/firebase.utils";

export type SetCurretUser = ActionWithPayload<USER_ACTION_TYPES.SET_CURRENT_USER, UserData>
...
export const setCurrentUser = withMatcher((user: UserData): SetCurretUser =>
